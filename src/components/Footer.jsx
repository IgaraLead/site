...
const resourceLinks = [
  ...
  { href: 'mailto:contato@igaralead.com.br', label: 'Contato' },
];
      ...
      <div className="container">
        <div className="footer-grid">
          <div className="footer-brand">
            ...
            <p>
              Plataforma Integrada de Receita — prospecção, enriquecimento, CRM, atendimento
              e automação em um único ecossistema.
            </p>
          </div>
          ...
          <div className="footer-links">
            ...
            <ul>
              ...
              <li>
                <a href="mailto:contato@igaralead.com.br">contato@igaralead.com.br</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="footer-bottom">
          <p>
            © {year} IgaraLead — CNPJ 64.670.800/0001-00. Todos os direitos reservados.
          </p>
          <div className="footer-social">
            ...
            <a
              href="https://linkedin.com/company/igaralead"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="LinkedIn"
            >
